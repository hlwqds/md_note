...
def test_customer_export():
    ...
    try:
        ...
        task_db_condition = {}
        task_db_condition["column"] = "cm_name,cm_tels,home_tels,enterprise_tels,cm_gender,cm_email,cm_addr,cm_company,cm_web_site,cm_detail,modify_time,defineField_43,defineField_44,defineField_45"
        task_db_condition["fixed_column_mask"] = 1
        task_db_condition["hide_customer_number"] = "xx****x"
        task_db_condition["ids"] = "42134"
        task_db_info["condition"] = task_db_condition
        async_task_id = test_batchcall_new_asynctask(db,task_db_info)
        del task_db_condition
